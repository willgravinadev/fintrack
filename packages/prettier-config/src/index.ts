import type { Options as PackageJSONOptions } from '@fintrack/prettier-plugin-package-json'
...
const fintrack = (options: Options = {}): Options => {
  ...
  return {
    ...
    plugins: [
      ...
      '@fintrack/prettier-plugin-package-json',
      ...plugins,
