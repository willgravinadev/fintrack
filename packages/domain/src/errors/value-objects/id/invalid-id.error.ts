...
export class InvalidIDError {
  ...
  constructor(parameters: ParametersConstructorDTO) {
    ...
    this.errorMessage = `Invalid ID to ${typeof parameters.modelNameOrValueObjectName === 'string' && Object.values(ValueObjectName).includes(parameters.modelNameOrValueObjectName as ValueObjectName) ? 'value object' : 'model'} ${parameters.modelNameOrValueObjectName}`
