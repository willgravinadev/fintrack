...
export class GenerateIDError {
  ...
  constructor(parameters: ParametersConstructorDTO) {
    ...
    this.errorMessage = `Error generating id to ${typeof parameters.modelNameOrValueObjectName === 'string' && Object.values(ValueObjectName).includes(parameters.modelNameOrValueObjectName as ValueObjectName) ? 'value object' : 'model'} ${parameters.modelNameOrValueObjectName}`
